const CONTENT = {
    ...
    form: {
        ...
        lbl_availability: { en: "Preferred Days/Time", fr: "Jours/Heure Préférés" },
    ...
    about: {
        ...
        affiliations: {
            title: { en: "Professional Affiliation", fr: "Affiliation professionnelle" },
            list: [
                {
                    logo: "media/logo_bps.png",
                    role: { en: "Chartered Member CPsychol 716681", fr: "Chartered Member CPsychol 716681" },
                    org: { en: "British Psychological Society (BPS)", fr: "British Psychological Society (BPS)" },
                ...
                },
                {
                    ...
                    org: { en: "Singapore Psychological Society (SPS)", fr: "Société de Psychologie de Singapour (SPS)" },
                    location: { en: "Singapore", fr: "Singapour" },
                    date: { en: "Since 2021", fr: "Depuis 2021" },
                },
                {
                    logo: "media/logo_aftcc.png",
                    role: { en: "Registered Therapist Practitioner", fr: "Thérapeute Praticien TCC" },
                    org: {
                ...
                },
                {
                    ...
                    role: { en: "Professional Member ‑ ACT Practitioner", fr: "Professional Member ‑ Praticien ACT" },
                    org: {
                ...
                },
                {
                    ...
                    org: { en: "Université Paris Cité Alumni", fr: "Université Paris Cité Alumni" },
                    location: { en: "France", fr: "France" },
        ...
        timeline: [
            ...
            },
            {
                ...
                desc: { en: "Worked at Thrive Family, The Other Clinic in Singapore", fr: "Thrive Family, The Other Clinic à Singapour" },
                top: 60,
                left: 75,
            },
            {
                ...
                desc: { en: "Brighton & Hove Therapy in Brighton, UK", fr: "Brighton & Hove Therapy à Brighton, UK" },
                top: 18,
                left: 43,
                labelPos: "top",
            },
    ...
    practice: {
        ...
        location_name: { en: "Brighton and Hove Psychotherapy", fr: "Brighton and Hove Psychotherapy" },
        address_lines: {
    ...
    services: {
        ...
        fees_desc: { en: "Individual session (50 mins): £100 / $180 SGD", fr: "Séance individuelle (50 mins) : 100£ / 180$ SGD" },
        insurance: {
            en: "I am registered with major insurance providers (AXA, Aviva, Vitality, etc.)",
            fr: "Je suis enregistrée auprès des principales assurances (AXA, Aviva, Vitality, etc.)",
        },
        cards: [
            {
                title: { en: "CBT — Cognitive Behavioural Therapy", fr: "TCC — Thérapie Cognitivo-Comportementale" },
                desc: {
            ...
            {
                title: { en: "ACT — Acceptance & Commitment Therapy", fr: "ACT — Thérapie d'Acceptation et d'Engagement" },
                desc: {
            ...
            {
                title: { en: "Supervision & Consultancy", fr: "Supervision & Consultation" },
                desc: {
    ...
    blog: [
        ...
        },
        {
            ...
            title: { en: "Understanding Anxiety: A First Step", fr: "Comprendre l'anxiété : Une première étape" },
            content: {
        ...
        },
        {
            ...
            date: "2024-04-10",
            img: "blog_act.webp",
            title: { en: "The Core Principles of ACT", fr: "Les principes fondamentaux de l'ACT" },
            content: {
        ...
        },
        {
            ...
            date: "2024-03-22",
            img: "blog_expat.png",
            title: { en: "Navigating Expat Life", fr: "Naviguer dans la vie d'expatrié" },
            content: {
        ...
        },
        {
            ...
            title: { en: "Why Supervision Matters", fr: "Pourquoi la supervision est importante" },
            content: {
