document.addEventListener("DOMContentLoaded", () => {
  ...
  const supervisionModalClose = document.getElementById(
...
function updateContent(lang) {
  ...
  document.getElementById("link-about").textContent =
    CONTENT.ui.nav_about[lang];
  document.getElementById("link-practice").textContent =
    CONTENT.ui.nav_practice[lang];
  document.getElementById("link-services").textContent =
    CONTENT.ui.nav_services[lang];
  ...
  document.getElementById("btn-bio-action").textContent =
    CONTENT.ui.btn_background[lang];
  ...
  document.getElementById("about-education").innerHTML =
    CONTENT.about.education[lang];
  document.getElementById("about-experience").innerHTML =
    CONTENT.about.experience[lang];
  ...
  document.getElementById("practice-main-title").textContent =
    pData.title[lang];
  ...
  document.getElementById("ip-loc-name").textContent =
    pData.location_name[lang];
  document.getElementById("ip-address").innerHTML =
    pData.address_lines[lang].join("<br>");
  ...
  document.getElementById("btn-contact-left").textContent =
    CONTENT.ui.btn_contact[lang];
  document.getElementById("ol-title").textContent = pData.online_title[lang];
  document.getElementById("ol-badge").textContent =
    CONTENT.ui.telehealth_badge[lang];
  ...
  document.getElementById("btn-contact-right").textContent =
    CONTENT.ui.btn_contact[lang];
  ...
  CONTENT.services.cards.forEach((card) => {
    const bgStyle = card.img
      ? `style="background-image: url('media/${card.img}');"`
      : "";
    const hasBgClass = card.img ? "has-bg" : "";

    const clickAttr = card.blogPostId
      ? `onclick="openBlogDrawer('${card.blogPostId}')"`
      : "";
  ...
  document.getElementById("fees-title").textContent =
    CONTENT.services.fees_title[lang];
  document.getElementById("fees-therapy-title").textContent =
    CONTENT.services.fees_therapy.title[lang];
  document.getElementById("fees-therapy-price").textContent =
    CONTENT.services.fees_therapy.price[lang];
  document.getElementById("fees-supervision-title").textContent =
    CONTENT.services.fees_supervision.title[lang];
  document.getElementById("fees-supervision-price").textContent =
    CONTENT.services.fees_supervision.price[lang];
  document.getElementById("fees-supervision-note").textContent =
    CONTENT.services.fees_supervision.note[lang];
  document.getElementById("insurance-info").textContent =
    CONTENT.services.insurance[lang];
  document.getElementById("book-btn").textContent = CONTENT.ui.btn_book[lang];
  document.getElementById("supervision-btn").textContent =
    CONTENT.ui.btn_supervision[lang];
  ...
  document.getElementById("lbl-email").textContent =
    CONTENT.form.lbl_email[lang];
  document.getElementById("lbl-availability").textContent =
    CONTENT.form.lbl_availability[lang];
  document.getElementById("lbl-type").textContent = CONTENT.form.lbl_type[lang];
  document.getElementById("opt-online").textContent =
    CONTENT.form.opt_online[lang];
  document.getElementById("opt-inperson").textContent =
    CONTENT.form.opt_inperson[lang];
  document.getElementById("lbl-message").textContent =
    CONTENT.form.lbl_message[lang];
  document.getElementById("btn-submit").textContent =
    CONTENT.form.btn_submit[lang];
  document
    .getElementById("modal-close")
    .setAttribute("aria-label", CONTENT.form.btn_close[lang]);

  // Supervision Modal Form Labels
  const sf = CONTENT.form_supervision;
  document.getElementById("supervision-modal-title").textContent =
    sf.title[lang];
  document.getElementById("sup-lbl-email").textContent = sf.lbl_email[lang];
  document.getElementById("sup-lbl-background").textContent =
    sf.lbl_background[lang];
  document.getElementById("sup-opt-trainee").textContent = sf.opt_trainee[lang];
  document.getElementById("sup-opt-qualified").textContent =
    sf.opt_qualified[lang];
  document.getElementById("sup-lbl-availability").textContent =
    sf.lbl_availability[lang];
  ...
  document
    .getElementById("supervision-modal-close")
    .setAttribute("aria-label", sf.btn_close[lang]);
...
function renderBlogCarousel(lang) {
  ...
  displayPosts.forEach((post, index) => {
    ...
    const imgHTML = post.img
      ? `<img src="media/${post.img}" alt="${title}" class="blog-thumb">`
      : `<div class="blog-no-img">📝</div>`;
...
window.openBlogDrawer = (id) => {
  ...
  const lang = document.getElementById("btn-fr").classList.contains("active")
    ? "fr"
    : "en";
  ...
  const imgHtml = post.img
    ? `<div id="drawer-img-container"><img src="media/${post.img}" alt=""></div>`
    : "";
  document.getElementById("drawer-body").innerHTML =
    imgHtml + post.content[lang];
