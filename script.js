document.addEventListener("DOMContentLoaded", () => {
    ...
    // 7. Practice Section Email Copy Logic
    function setupEmailCopy(emailElId, toastId) {
        document.getElementById(emailElId).addEventListener("click", (e) => {
            e.preventDefault()
            const email = document.getElementById(emailElId).textContent
            navigator.clipboard.writeText(email).then(() => {
    ...
    setupEmailCopy("ip-email", "ip-copy-toast")
    setupEmailCopy("sg-email", "sg-copy-toast")
